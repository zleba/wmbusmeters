...
if [ $CONFIG_MQTTDISCOVERY_ENABLED == "true" ]; then
    ...
    wget -O - https://github.com/zleba/wmbusmeters/archive/refs/heads/master.tar.gz 2> /dev/null | tar xz --strip=3 "wmbusmeters-master/ha-addon/mqtt_discovery" -C $templatedir || true
